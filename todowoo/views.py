...
def viewtodo(request,todo_pk):
    ...
    if request.method == 'GET':
        ...
        return render(request,'viewtodo.html', {'todos':todos, 'forms':forms})
    else:
        try:
...
def createtodo(request):
    if request.method == 'GET':
        return render(request,'createtodo.html',{'forms':TodoForm()})
    else:
        try:
            ...
            return render(request,'createtodo.html',{'forms':TodoForm(), 'error':"Bad Title"})
